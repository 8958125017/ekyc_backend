...
module.exports  = {
    revocationFromTelemarketer : (sendMailData) => {
        return `
        <!doctype html>
                        <html>
                          <head>
                                    ...
                                    <table class="main">
                                      <tr>
                                        <td style="text-align: center; padding: 20px; background-color: #3aa7e5;">
                                          ...
                                          <!-- <img src="https://blockcube.s3.amazonaws.com/1562307986020_Teledgers.png" width="210"> -->
                                        </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              <td>
                                                ...
                                                <p style="font-size: 20px; font-weight: bold;">Dear ${sendMailData.tmName},</p>
                                                <!-- <p style="color: #000; font-size: 18px;">Congratulations!!</p> -->
                                                <p style="color: #000;">Your request to terminate all kind of Commercial Communication business relationship with “Entity Name” has been approved.</p>

                                                <p style="color: #000;">Hence, all the headers, contents and consents of ${sendMailData.eName} will not be displayed on your portal for any future commercial communication.  </p>
