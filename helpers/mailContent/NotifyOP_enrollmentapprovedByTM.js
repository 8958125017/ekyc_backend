    	 ...
    	 <div class="Rectangle">
    	    ...
    	    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
    				...
    				<p style="font-size: 12px; ">The Entity Enrolment request with <strong>Ref. ID ${sendMailData.ref}</strong>, is succesful.</p>

    				<p class="approved"><img src=${sendMailData.gtick}  class="Group"> APPROVED</p>

    				<p style="font-size: 12px; ">Details are as follows-</p>

    				<p style="font-size: 14px; margin-bottom: 71px; font-family: 'Roboto Medium';  font-style:medium">
    			     	 <b>${sendMailData.peid} </b> ${sendMailData.pename} request to<br>
