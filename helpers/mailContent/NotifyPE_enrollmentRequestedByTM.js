...
module.exports={
  template:(sendMailData)=>{
    ...
    <html>
        ...
        <title>TM Entity Request Notification</title>
    	 ...
    	 <div class="Rectangle">
    	    ...
    	    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
    			    ...
    			    <p class="WelcomeText">Telemarketer-Entity Enrolment Request</p>
    				</td>
                </tr>
                ...
                <tr>
    				...
    				<p style="font-size: 12px; ">You have got a Entity Enrolment request from</p>

    				<p style="font-size: 14px; margin-bottom:50px; ">

     				 <b>Telemarketer ID ${sendMailData.tmid}</b> ${sendMailData.tmname}  to<br>
    				   <b>Entity ID ${sendMailData.peid}</b> ${sendMailData.pename}  <br>
    				   <br>
    		     		<span style="font-size: 12px; "><strong>Please be Patient & wait for Operator’s approval.</strong></span>
    				</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
    						<p class="TM-NameE">
    						Click below to check the Enrolment Status.
    					 </p>
    			</td>
                </tr>
