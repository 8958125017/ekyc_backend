  ...
  template:(sendMailData)=>{
    ...
    <html>
       <head>
          ...
          <title>TELEMARKETER - ENTITY EMAIL VERIFICATION LINK</title>
          ...
          <div class="Welcome-for-PETM">
             <div class="Rectangle">
                <p class="logo-section">
                   <img src="https://pingconnect.in/docs/1579084994398_Connect_White_150x63.png" alt="alt_text" border="0" class="globe">
                </p>
                <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                   <tr>
                      <td style="text-align:center;">
                         <p class="WelcomeText">TELEMARKETER - ENTITY EMAIL <br> VERIFICATION LINK </p>
                      </td>
                   </tr>
                   <tr>
                      <td>
                   ...
                   <tr>
                      <td style="line-height: 26px; color: #474747;font-family:  'Roboto';">
                         <p style="font-size: 13px; margin-bottom:30px; ">
                            <b>Telemarketer ID ${sendMailData.tid} (${sendMailData.tname})</b>  has requested you to verify your Email ID.As this is the first step towards getting your profile verified.
                         </p>
                         <p style="font-size: 12px; margin-bottom: 50px; ">This Email ID will be used as your primary communication Email address. Please click <b>VERIFY NOW</b> to complete the process.</p>
                      </td>
                   </tr>
                   <tr>
                      <td style="line-height: 30px; color: #474747;font-family:  'Roboto';">
                         <p>
                            <a class="login" href=${sendMailData.verfiyLink}>VERIFY NOW <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                         </p>
                         <p style="font-size: 13px; margin-top:10px;">Or paste this link to your browser.</p>
                         <a href="#" class="loginLink"> <i>${sendMailData.verfiyLink}</i></a>
                      </td>
                   </tr>
                   <tr>
                      <td >
