    	 ...
    	 <div class="Rectangle">
    	    ...
    	    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
    				...
    				<p style="font-size: 12px; ">There is a Entity Enrolment request with <strong>Ref. ID ${sendMailData.ref}</strong>, details are as follows-</p>

    				<p style="font-size: 14px; margin-bottom:50px; ">

     				   <b>Telemarketer ID ${sendMailData.tmid}</b> ${sendMailData.tmname} request to <br>
                ...
                <tr>
                    <td>
    						<p class="TM-NameE">
    						Click below to Approve/Rejects the Enrolment.
    					 </p>
    			</td>
                </tr>
