...
module.exports = {
    revocationOfTApproval: (sendMailData) => {
        return `<!doctype html>
				<html>
				  <head>
								  ...
								  <table border="0" cellpadding="0" cellspacing="0">
									<tr>
									  <td>
										...
										<p style="color: #000;">As per the request from {sendMailData.eName} the Commercial Communication business relationship stands revoked.</p>
