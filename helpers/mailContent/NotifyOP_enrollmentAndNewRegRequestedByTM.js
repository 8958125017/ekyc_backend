...
module.exports={
  template:(sendMailData)=>{
    ...
    <html>
        ...
        <title>TM Register New Entity</title>
    	 ...
    	 <div class="Rectangle">
    	    ...
    	    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
    			    ...
    			    <p class="WelcomeText">Telemarketer-New Entity Registeration Request and Enrolment</p>
    				</td>
                </tr>
                ...
                <tr>
    				...
    				<p style="font-size: 12px; ">There is a Entity Registeration & Enrolment request with <b>Ref. ID ${sendMailData.ref} </b></p>
    				...
    				<p style="font-size: 14px; margin-bottom: 71px; ">
    			        ...
    			        request to ${sendMailData.pename}.
    				</p>
                ...
                <tr>
                    <td>
    						<p class="TM-NameE">
    						 Click below to Approve/Rejects the Registeration.
    					 </p>
    			</td>
                </tr>
