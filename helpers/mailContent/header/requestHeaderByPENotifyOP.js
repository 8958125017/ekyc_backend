...
module.exports={
  template:(sendMailData)=>{
    ...
    <html>
        ...
        <title>Header-Registraiton</title>
         ...
         <div class="Rectangle">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
                    ...
                    <p class="WelcomeText">Entity Header Registeration</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <p style="font-size: 12px; ">There is a Header Registeration  <b>${sendMailData.cli}</b> request from</p>
