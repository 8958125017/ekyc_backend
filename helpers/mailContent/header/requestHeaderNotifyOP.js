...
const opURL = require('../../config.js').opURL
module.exports={
  template:(sendMailData)=>{
    ...
    <html>
        ...
        <title>Telemarketer-Entity-Header-Request-Op</title>
         ...
         <div class="Rectangle">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
                    ...
                    <p class="WelcomeText">Telemarketer - Entity Header Request</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <p style="font-size: 12px; ">There is a Header Registeration request with  <b>Header Name - ${sendMailData.cli}</b>, from</p>
                    
                    <p style="font-size: 13px; margin-bottom:50px; ">
                     
                      <b>Telemarketer ID ${sendMailData.tmid}</b> {${sendMailData.tmName}} for  <br>
                      <b>Entity ID ${sendMailData.peid}</b>{${sendMailData.peName}}.<br>
                    </p>
                    </td>
                </tr>
                ...
                <tr>
                   ...
                   <tr>
                    <td>
                    <p>
                      <a class="login" href=${sendMailData.opURL}>CHECK NOW <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                      </p>
                      </td>
                </tr>
