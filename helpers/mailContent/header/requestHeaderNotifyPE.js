...
module.exports={
  template:(sendMailData)=>{
    ...
    <html>
        ...
        <title>Telemarketer-Entity-Header-Request</title>
         ...
         <div class="Rectangle">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
                    ...
                    <p style="font-size: 12px; ">There is a Header Registeration (${sendMailData.cli}) request for your</p>
                    
                    <p style="font-size: 14px; margin-bottom:50px; ">
                     
                      <b>Entity ID ${sendMailData.peid}</b> {${sendMailData.peName}} by<br>
                      <b>Telemarketer ID ${sendMailData.tmid}</b> {${sendMailData.tmName}}.
                    </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                            <p class="TM-NameE"> 
                                <b>Please be Patient & wait for Operator’s approval.</b>
                         </p>
                  </td>
                </tr>
