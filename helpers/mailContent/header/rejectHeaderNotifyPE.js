...
const entityURL = require('../../config.js').entityURL
module.exports={
  template:(sendMailData)=>{
    ...
    sendMailData["entityURL"]=entityURL
    ...
    .rejected {
        ...
        <div class="Welcome-for-PETM">
         <div class="Rectangle">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
                    ...
                    <p class="WelcomeText">Entity Header Registration status</p>
                    </td>
                </tr>
         ...
         <tr>
                    ...
                    <p style="font-size: 12px; ">Your Header Registration  ${sendMailData.cli} request is Unsuccessful.
                   </p>
                    
                    <p class="rejected"><img src=${sendMailData.rcross}  class="Group">  REJECTED</p>
                    
                    
                    <p style="font-size: 12px;  font-family: 'Roboto Medium', sans-serif;font-weight:500; line-height: 20px;">
                ...
                <tr>
                    <td>
                            <p class="TM-NameE">
                            Click below to check the Header Registration Status.
                         </p>
                </td>
                </tr>
                   ...
                   <tr>
                    <td>
                    <p>
                      <a class="login" href=${sendMailData.entityURL}>CHECK NOW <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                      </p>
                      </td>
                </tr>
