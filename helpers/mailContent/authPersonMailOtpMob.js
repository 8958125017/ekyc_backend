...
module.exports = {
    authPersonMailOtpMob : (sendMailData) => {
        return `<!doctype html>
        <html>
          <head>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                ...
                                <p style="color: #000;">Your One Time Password (OTP)

                               to update mobile number of the Authorised
                                Person is  <span style="font-weight: bold;">${sendMailData.otp}. </span> In case you have not requested, please contact our</p>
