...
module.exports = {
    authPersonMailOtp : (sendMailData) => {
                    ...
                    <table class="main">
                      <tr>
                        <td style="text-align: center; padding: 20px; background-color: #3aa7e5;">
                          <img src=${sendMailData.logo} width="210">
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                ...
                                to edit the details of Authorised
                                 Person is <span style="font-weight: bold;">${sendMailData.otp}. </span> In case you have not requested, please contact
                                  our help desk.</p>
