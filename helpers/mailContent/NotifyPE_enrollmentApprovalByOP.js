  ...
  template:(sendMailData)=>{
    ...
    * {
    ...
    .approved {
        ...
        </style>enrollmentApprovalNotification
        </head>
    	...
    	<div class="Welcome-for-PETM">
    	 <div class="Rectangle">
    	    ...
    	    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" class="email-container" style="width: 100%;">
                ...
                <tr>
    			  <td>
    			   <p class="Dear-Telemarketer"> <strong>Dear ${sendMailData.pename},</strong></p>
    			    </td>
    			  </tr>
                ...
                <tr>
    				...
    				<p style="font-size: 12px; ">Your Entity Enrolment request is succesfully.</p>
    				...
    				<p style="font-size: 14px; margin-bottom: 71px; ">
    			     	 ...
    			     	 <strong>Entity ID ${sendMailData.peid}</strong> ${sendMailData.pename} to  <br>
    		     		<strong>Telemarketer ID ${sendMailData.tmid}</strong> ${sendMailData.tmname}  <br>
    				</p>
